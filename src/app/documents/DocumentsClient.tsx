...
export default function DocumentsClient({ locale = "zh" }: { locale?: Locale }) {
  const containerRef = useRef<HTMLDivElement>(null);
  const documents = (compiledArticles as ArticleIndexItem[]).filter((art) => art.type === "documents");
  const copy = articleListCopy(locale, "documents");
