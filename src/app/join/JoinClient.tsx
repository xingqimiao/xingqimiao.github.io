...
type JoinContent = {
  ...
  description_bottom_html?: string;
  description_bottom_html_en?: string;
  wechat_qr?: string;
...
export default function JoinClient({
  ...
  const bottomDescription = content.description_bottom_html || content.description_bottom_html_en
    ? resolveLocalizedContent(
        locale,
        content.description_bottom_html || "",
        content.description_bottom_html_en,
      )
    : undefined;
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-white px-6 pb-24 pt-32">
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div
          lang={description.effectiveLocale === "en" ? "en" : "zh-CN"}
        ...
        {bottomDescription?.value && (
          <div
            lang={bottomDescription.effectiveLocale === "en" ? "en" : "zh-CN"}
            className="g2-markdown fade-in prose prose-lg mb-16 max-w-3xl text-text-sub prose-p:leading-relaxed prose-a:text-text-main prose-a:underline prose-strong:text-text-main"
            dangerouslySetInnerHTML={{ __html: bottomDescription.value }}
          />
        )}
