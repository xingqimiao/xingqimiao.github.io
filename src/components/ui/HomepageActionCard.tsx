...
export function HomepageActionCard({ title, coverName }: HomepageActionCardProps) {
  return (
    <div className="group relative h-[220px] sm:h-[300px] md:h-[400px] overflow-hidden rounded-[32px] md:rounded-[48px] bg-white p-[20px_20px_0_20px] md:p-[38px_38px_0_38px]">
